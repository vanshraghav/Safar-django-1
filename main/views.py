...
from .models import Delhi,Contact,Surat,Mumbai,Chennai
...
def explore_surat(request):
    explore_surat= Surat.objects.all()
    return render(request, 'surat.html',{'explore_surat':explore_surat})
def explore_mumbai(request):
    explore_mumbai=Mumbai.objects.all()
    return render(request,'mumbai.html',{'explore_mumbai':explore_mumbai})
def explore_chennai(request):
    explore_chennai=Chennai.objects.all()
    return render(request,'chennai.html',{'explore_chennai':explore_chennai})
